...
public class TaskListContent {
    ...
    static {
        addItem ( new Task ( String.valueOf ( 1 ), "Mama", "Moja mama", "25.05.1971" ) );
        addItem ( new Task ( String.valueOf ( 2 ), "Tata", "Mój tata", "22.08.1970" ) );
        addItem ( new Task ( String.valueOf ( 3 ), "Marta", "Moja dziewczyna", "07.02.1997" ) );
    }
